...
from src.core.security_monitor import security_monitor
from src.core.security_events import security_event_tracker, AlertLevel, EventCategory
...
async def security_health_check() -> Dict[str, Any]:
    ...
    try:
        ...
        # Check rate limiter
        try:
            test_status = await rate_limiter.get_rate_limit_status("health_check")

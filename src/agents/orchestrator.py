...
class AgentOrchestrator:
    ...
    Implements the _smart_agent_detection() logic from the reference system
    with enhancements for multi-agent scenarios and emergency handling.
    """
    ...
    def __init__(self, ai_service: HealthcareAIService):
        ...
        self.agents: Dict[str, BaseAgent] = {
            "illness_monitor": IllnessMonitorAgent(ai_service),

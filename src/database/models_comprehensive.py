...
class User(Base, TimestampMixin):
    ...
    # Constraints
    __table_args__ = (
        CheckConstraint("role IN ('user', 'admin', 'medical_reviewer', 'data_manager', 'super_admin')", name='ck_user_role'),
        CheckConstraint("language_preference IN ('en', 'zh-HK', 'zh-CN')", name='ck_user_language'),
    )
...
class Conversation(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint("language IN ('en', 'zh-HK', 'zh-CN')", name='ck_language'),

...
from src.ai.openrouter_client import OpenRouterClient, get_openrouter_client
        ...
        for model_tier, cost in summary.model_breakdown.items():
            ...
            if cost_percentage > 50 and model_tier == "premium":
                recommendations.append({
                    ...
                    "suggestion": f"Consider using lite models for routine queries to reduce costs",
